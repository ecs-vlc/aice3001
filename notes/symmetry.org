...
#+SUBTITLE: Subsidiary Notes --- Lecture 30: Symmetry
#+SETUPFILE: setup.org
...
** Group Theory
   ...
   * For the set, $\mathcal{G}$, and binary operation, "$\cdot$" to form a group they must satisfy four conditions
...
* COMMENT [[file:overfitting.org][Previous]]
