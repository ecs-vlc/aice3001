...
#+SUBTITLE: Subsidiary Notes --- Lecture 23: Gaussian Processes
#+SETUPFILE: setup.org
#+LATEX_HEADER: \renewcommand{\normal}[1]{\mathcal{N}\!\left( #1 \right)}
#+LATEX_HEADER: \renewcommand{\eq}[1][=]{\stepcounter{eqCounter}\stackrel{\text{\tiny(\alph{eqCounter})}}{#1}}
   ...
   * It is more useful to compute the probability at a particular
     ...
     - To compute this we marginalise over all other points
       ...
       + If you have a multivariate normal distribution
         ...
         (\bm{x}-\bm{\mu})^\tr \mat{C}^{-1}\, (\bm{x}-\bm{\mu})} $$
...
* COMMENT [[file:integration.org][Previous]]  [[file:ProbabilisticInference.org][Next]]
