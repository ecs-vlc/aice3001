...
\begin{question}{10}
  \begin{qparts}
    \qpart[4]{Starting from the definition of a convex function where,
      for $a\in[0,1]$,
      ...
      \begin{answer}
        ...
        \begin{align*}
          ...
          f(x) - f(y)
        \end{align*}
        Taking the limit $\epsilon \rightarrow 0$ and then using
        \begin{align*}
      ...
      \end{answer}
      \qpart[4]{Starting from the inequality for a convex function, $f$,
        ...
        order $\epsilon^2$, show that $f''(x)\geq0$.
      }{\lines{8}}
      \begin{answer}
...
\begin{question}{10}
  \begin{qparts}
    ...
    \begin{answer}
      ...
      $\mat{B}= \mat{V}^\tr$ and (2) $\mat{V}^\tr\mat{V}=\Id$.
    \end{answer}
  ...
  \begin{qparts}
    ...
    \begin{answer}
      ...
      \begin{align*}
        ...
        \len{\mat{A}\bm{x}}_2
      \end{align*}
      using $,\mat{V}^\tr\mat{V}=\Id$.  But as $\bm{x}$ is a
      unit vector that maximises $ \len{\mat{A}\bm{x}}_2$ then
      $\bm{y}$ will be a unit vector that maximise
      $\len{\mat{A}\,\mat{V}^\tr\bm{y}}_2 $ and thus
      $\len{\mat{A}\,\mat{V}^\tr}_2=\len{\mat{A}}_2$.
    \end{answer}
    ...
    \end{answer}
    \freshpage \qpart[1]{Compute $\len{\mat{S}\,\bm{x}}_2^2$ where
...
\begin{question}{10}
  \begin{qparts}
    \qpart[2]{We consider the mapping $\bm{y}= \mat{M}\,\bm{x}$ where
      ...
      and $s_{max}$, where $s_{max}$ follows the same definition as in Q3(e).}{\lines{3}}
    \begin{answer}
      \begin{align*}
