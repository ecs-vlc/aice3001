%% Standalone lecture -- build with:  pdflatex -shell-escape graphicalModels
\input{preamble}
...
\begin{PauseHighLight}
  ...
  \item It allows us to build a joint probability distribution from
    which we can compute everything we want\pause
  \end{itemize}
\end{PauseHighLight}
...
\begin{PauseHighLight}
  ...
  \item In the subsidiary notes I present a very simple program for
    ...
    test this out, as it makes things much clearer\pauseb
  \end{itemize}
\end{PauseHighLight}
