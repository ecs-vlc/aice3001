%% Standalone lecture -- build with:  pdflatex -shell-escape pca
\input{preamble}
...
\item Full rank covariance matrices that have positive eigenvalues only and are
