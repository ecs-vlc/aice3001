%% Standalone lecture -- build with:  pdflatex -shell-escape projects
\input{preamble}
...
\vspace{-1cm}
\begin{center}
\noindent\includegraphics[height=90mm]{mad-scientist.jpg}
\end{center}
\keywords{Details, Ideas, Research Methods}
%%%%%%%%%%%%%%%%%%%%%%% Next Slide %%%%%%%%%%%%%%%%%%%%%%%
...
\begin{minipage}{8cm}\raggedright
  \begin{enumerate}\squeeze
    \outlineitem{Rules of the Game}{rules}
    \outlineitem{Ideas}{ideas}
    \outlineitem{How to Do a ML Project}{how}
  \end{enumerate}
\end{minipage}\hfill
\begin{minipage}{13cm}
\ifnum\value{outlineitem}=1
  \includegraphics[width=11cm]{project.jpg}
\fi
\ifnum\value{outlineitem}=2
  \includegraphics[width=13cm]{frankenstein_alive.jpg}
\fi
\ifnum\value{outlineitem}=3
  \includegraphics[width=9cm]{book.jpeg}
\fi
\end{minipage}
\end{slide}
